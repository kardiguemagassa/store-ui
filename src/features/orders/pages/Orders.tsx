...
import type { OrderItemResponse, OrderResponse } from "../types/orders.types";
        ...
        {orders.map((order) => (
          ...
          >
            <h2 className="text-xl font-semibold mb-2 text-primary dark:text-lighter">
              Commande {order.totalPrice || `ORD-${order.orderId}`}
            </h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Statut: <span className="font-medium">{order.orderStatus}</span>
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-400">
